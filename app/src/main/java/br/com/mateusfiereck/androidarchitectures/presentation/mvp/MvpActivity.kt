...
class MvpActivity : AppCompatActivity(), MvpViewContract {

    private val presenter by inject<MvpPresenter> {
        parametersOf(this)
    }
    ...
    override fun showSuccess(model: CharacterModel) {
    ...
    override fun showOriginDialog(origin: CharacterModel.Origin?) {
